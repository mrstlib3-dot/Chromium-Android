...
//        final boolean usingDesktopUserAgent = getUseDesktopUserAgent();
//        setUseDesktopUserAgent(true, false);
//        RecordUserAction.record("MobileMenuRequestDesktopSite");
//        final boolean usingDesktopUserAgent2 = getUseDesktopUserAgent();
    }
...
//            webContents.getNavigationController().setUseDesktopUserAgent(true, false);
//            RecordUserAction.record("MobileMenuRequestDesktopSite");
    ...
    protected void didFinishPageLoad(String url) {
        ...
        if (url != null && !url.contains("chrome-native")) {
            enterFullscreenMode(new FullscreenOptions(false));
            showMediaDownloadInProductHelp(60, 60, 60, 60);
        }
    }
    ...
    protected void initWebContents(WebContents webContents) {
        ...
        boolean useDesktopUserAgent2 = webContents.getNavigationController().getUseDesktopUserAgent();
    ...
    private void initBrowserComponents(WebContents webContents) {
        try {
            ...
            boolean useDesktopUserAgent = mWebContents.getNavigationController().getUseDesktopUserAgent();
...
//            view.setBackground(pulseDrawable);
            view.setBackgroundResource(R.drawable.fullscreen);
            ...
            mPulsePopupWindow.getContentView().setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (isFullScreen) {
                        exitFullscreenMode();
                        mPulsePopupWindow.update(60, 240, 60, 60);
                    } else {
                        enterFullscreenMode(new FullscreenOptions(false));
                        mPulsePopupWindow.update(60, 60, 60, 60);
                    }
//                    hideMediaDownloadInProductHelp();
                }
            });
     ...
     */
    public @Nullable
    String getTrustedCdnPublisherUrl() {
        ChromeActivity activity = getActivity();
